/* MemIf_Types.h — AUTOSAR Memory Abstraction Interface Types.
 *
 * Provides MemIf_StatusType, MemIf_JobResultType and MemIf_ModeType
 * used by Fls, Fee, NvM, and MemIf modules.
 * Based on AUTOSAR SWS_MemoryAbstractionInterface (R4.x / R20-11).
 *
